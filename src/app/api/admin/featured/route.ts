...
const DATA_PATH = path.join(process.cwd(), 'src', 'data', 'featured.json');
...
export async function POST(req: Request) {
    try {
        ...
        try {
            ...
            const newImagePaths = new Set(newData.map((s: any) => s.photo));
        ...
        return NextResponse.json({ message: 'Featured images updated successfully' });
    } catch (error) {
